...
// Thinking mode type (mirrored from shared types to avoid import issues)
type ThinkingModeLocal = 'off' | 'low' | 'medium' | 'high' | 'ultra';

// Thinking badge configuration - color based on thinking mode
export function getThinkingBadgeConfig(thinkingMode?: ThinkingModeLocal): ToolBadgeConfig {
  const mode = thinkingMode ?? 'medium';
  ...
  switch (mode) {
    case 'off':
      return {
        ...
        colors: {
          border: 'border-neutral-200/60 dark:border-neutral-500/30',
          bg: 'bg-neutral-50/80 dark:bg-neutral-500/10',
          text: 'text-neutral-500 dark:text-neutral-400',
          hoverBg: 'hover:bg-neutral-100/80 dark:hover:bg-neutral-500/20',
          chevron: 'text-neutral-400 dark:text-neutral-500',
    ...
    case 'low':
      return {
        ...
        colors: {
          ...
          chevron: 'text-pink-300 dark:text-pink-400',
          iconColor: 'text-pink-300 dark:text-pink-400'
        }
      };
    case 'medium':
      return {
        icon: <Brain className="size-2.5" />,
        colors: {
          border: 'border-pink-300/60 dark:border-pink-500/40',
          bg: 'bg-pink-100/80 dark:bg-pink-500/15',
          text: 'text-pink-500 dark:text-pink-400',
          hoverBg: 'hover:bg-pink-200/80 dark:hover:bg-pink-500/25',
          chevron: 'text-pink-400 dark:text-pink-500',
    ...
    case 'high':
      return {
        ...
        colors: {
          ...
          bg: 'bg-pink-200/80 dark:bg-pink-500/20',
          text: 'text-pink-600 dark:text-pink-400',
          hoverBg: 'hover:bg-pink-300/80 dark:hover:bg-pink-500/30',
          chevron: 'text-pink-500 dark:text-pink-500',
    ...
    case 'ultra':
      return {
        ...
        colors: {
          ...
          bg: 'bg-gradient-to-r from-pink-100 via-purple-100 to-blue-100 dark:from-pink-500/15 dark:via-purple-500/15 dark:to-blue-500/15',
          text: 'text-purple-600 dark:text-purple-400',
          hoverBg:
            'hover:bg-gradient-to-r hover:from-pink-200 hover:via-purple-200 hover:to-blue-200 dark:hover:from-pink-500/25 dark:hover:via-purple-500/25 dark:hover:to-blue-500/25',
          chevron: 'text-purple-500 dark:text-purple-500',
